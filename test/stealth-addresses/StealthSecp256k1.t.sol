...
contract StealthSecp256k1Test is Test {
    ...
    function test_StealthMetaAddress_toString() public {
        SecretKey spendSk = Secp256k1.secretKeyFromUint(
            uint(
                0x5a21e92ba5784ad9e94c9d670d3b21baff82c1668aa9ef9bd039674c7d4589f8
            )
        );
        SecretKey viewSk = Secp256k1.secretKeyFromUint(
            uint(
                0xf6956ed1c1488982a7a80be72fa0ec8cc978d2c957b431e8b363557e552dbb75
            )
        );
        ...
        string memory got = wrapper.toString(sma, chain);
